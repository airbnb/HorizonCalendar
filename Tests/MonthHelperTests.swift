...
final class MonthHelperTests: XCTestCase {
  ...
  func testMonthContainingDate() throws {
    let january2020Date = try XCTUnwrap(gregorianCalendar.date(
    ...
    let december0050Date = try XCTUnwrap(gregorianCalendar.date(
    ...
    let september02Date = try XCTUnwrap(japaneseCalendar.date(
  ...
  func testFirstDateOfMonth() throws {
    ...
    let april0050ExpectedDate = try XCTUnwrap(gregorianCalendar.date(
    ...
    let may05ExpectedDate = try XCTUnwrap(japaneseCalendar.date(
  ...
  func testLastDateOfMonth() throws {
    ...
    let october0050ExpectedDate = try XCTUnwrap(gregorianCalendar.date(
    ...
    let july06ExpectedDate = try XCTUnwrap(japaneseCalendar.date(
