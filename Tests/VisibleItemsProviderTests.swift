...
final class VisibleItemsProviderTests: XCTestCase {
  ...
  func testVisibleItemsContextAfterMetricsChange() {
    ...
    let expectedVisibleItemDescriptions: Set<String> = [
      ...
      "[itemType: .dayRange(2020-03-11, 2020-04-05), frame: (5.0, 409.5, 310.0, 370.0)]",
      "[itemType: .daysOfWeekRowSeparator(2020-3), frame: (-0.0, 350.5, 320.0, 1.0)]",
      "[itemType: .daysOfWeekRowSeparator(2020-4), frame: (0.0, 702.5, 320.0, 1.0)]",
      ...
      "[itemType: .layoutItemType(.monthHeader(2020-04)), frame: (0.0, 555.5, 320.0, 100.0)]",
      "[itemType: .monthBackground(2020-02), frame: (0.0, -56.0, 320.0, 302.0)]",
      "[itemType: .monthBackground(2020-03), frame: (-0.0, 246.0, 320.0, 302.0)]",
      "[itemType: .monthBackground(2020-04), frame: (0.0, 548.0, 320.0, 352.5)]",
    ]
